...
final class DefaultUserController extends Controller
{
    ...
    public function actionCreate(): int
    {
        ...
        if (!$this->confirm(
            ...
            /**
             * Скасування користувачем означає, що запитану операцію не було виконано.
             * Повертаємо ненульовий код завершення, щоб зовнішні команди, зокрема Setup,
             * могли коректно визначити, що початкове налаштування не завершено.
             */
